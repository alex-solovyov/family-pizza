...
import cartClearImage from '../assets/images/empty-cart.png'
            ...
            {totalCount
                ? <div className="cart">
                    ...
                    <div className="content__items">
                        {addedPizzas.map(item => <CartItem key={item.id} item={item} totalCount={items[item.id].length} />)}
                    </div>
                ...
                : <div className="cart cart--empty">
                    ...
                    <img src={cartClearImage} alt="Empty cart" />
